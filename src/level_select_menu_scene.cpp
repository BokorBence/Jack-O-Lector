...
Level_select_menu_scene::Level_select_menu_scene(SDL_Renderer* r, Scene* next_scene)
{
	next = next_scene;
	renderer = r;
	level1 = new Button(0, 0, 0, 0, 0, 300, 355, 80, "resources/level_select", r);
	level2 = new Button(0, 0, 0, 0, 370, 300, 355, 80, "resources/level_select", r);
	level3 = new Button(0, 0, 0, 0, 725, 300, 355, 80, "resources/level_select", r);
